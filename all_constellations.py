...
# Abbreviated name, full name, central RA (hr), central Dec (deg), angular
# width of field of view (deg)
constellations_list = (
...
# CHART
# output_filename={output_dir}/{output_filename}.svg
"""
    ...
    for item in constellations_list:
        ...
        with open(config_filename, "w") as out:
            out.write(template_configuration.format(
                output_dir="figures/constellations/",
        ...
        # Make star chart
        os.system("/usr/local/bin/starchart.bin {}".format(config_filename))
